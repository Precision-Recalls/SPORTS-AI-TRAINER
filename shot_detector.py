...
import math
import numpy as np
from utils1 import score1, detect_down, detect_up, in_hoop_region, clean_hoop_pos, clean_ball_pos


class ShotDetector:
    def __init__(self):
        # Load the YOLO model created from main.py - change text to your relative path
        self.model = YOLO("/Users/garvagarwal/Desktop/SPORTS-AI-TRAINER/best_yolo8s.pt")
        self.class_names = ['ball', 'basket','person']
        ...
        self.cap = cv2.VideoCapture("/Users/garvagarwal/Desktop/SPORTS-AI-TRAINER/test/two_score_three_miss.mp4")
        ...
        self.makes = 0
        self.attempts = 0
        self.body_index = {"left_shoulder": 5, "left_elbow": 7, "left_wrist": 9,
              "right_shoulder": 6, "right_elbow": 8, "right_wrist": 10,
              "left_knee": 13, "right_knee": 14, "left_ankle": 15, "right_ankle": 16}
        self.pose_model = YOLO("/Users/garvagarwal/Desktop/SPORTS-AI-TRAINER/assets/models/yolov8s-pose.pt")  # Assuming you have a YOLO pose model
        self.step_counter = 0
        ...
        if len(self.hoop_pos) > 0 and len(self.ball_pos) > 0:
            ...
            if self.frame_count % 10 == 0:
                if self.up and self.down and self.up_frame < self.down_frame:
                    ...
                    is_goal, description=score1(self.ball_pos, self.hoop_pos)
                    print(description)
    ...
    def display_score(self):
        ...
        cv2.putText(self.frame, f"Shots:{self.attempts}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
        cv2.putText(self.frame, f"Goals:{self.makes}", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
...
if rim_x1 < predicted_x < rim_x2:
        if px-r>rimx1 and px+r<rimx2 and px==rim center:clean goal
        elif (px-r>rimx_touchx1 and px+r<rimx2) or (px+r<rim_touchx2 and px-r>rimx1):goal touching the rim
else: No goal
''' 