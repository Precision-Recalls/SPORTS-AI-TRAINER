...
def get_basketball_configs():
    ...
    return sample_video_path, basketball_output_video_path, class_names, body_index


def analyze_basketball_video(class_names, video_path, basketball_output_video_path, body_index):
    BasketBallGame(object_detection_model, pose_detection_model, class_names, video_path, basketball_output_video_path, body_index)


sample_video_path, basketball_output_video_path, class_names, body_index = get_basketball_configs()
analyze_basketball_video(class_names, sample_video_path, basketball_output_video_path, body_index)
